...
module.exports = "<p>\n  Go To Home <a href=\"\" (click)=\"sendMeHome()\"><strong>Take me back</strong></a>\n</p>\n<ul>\n  <li *ngFor=\"let goal of goals\">\n    {{ goal }}\n  </li>\n</ul>\n<br>\n<br>\n\n<ng-gauge [max]=\"100\" [input]=\"guagenum\"> </ng-gauge>\n\n<div>\n  <form class=\"guage\">\n      <input type=\"text\" name=\"item\"  [(ngModel)]=\"guagenum\">\n    </form>\n</div>"
...
var AboutComponent = (function () {
    function AboutComponent(route, router, _data) {
        ...
        this._data = _data;
        this.guagenum = 55;
        this.guageBtnTxt = 'Enter a number';
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_ng2_gauge__ = __webpack_require__("../../../../ng2-gauge/index.js");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var DataService = (function () {
    function DataService() {
        this.goals = new __WEBPACK_IMPORTED_MODULE_1_rxjs_BehaviorSubject__["a" /* BehaviorSubject */](['First goal', 'Second goal']);
